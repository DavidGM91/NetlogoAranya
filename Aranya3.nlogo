...
to eat-aranya
  ...
  [
    ifelse count Granotes-here with [Vida < 250] > 0 and count Granotes-here < 5
    [
      let presa one-of Granotes-here with [Vida < 250]
      ask presa[ morir]
      set Inanició  0
      beep
    ]
    [
      ...
      ;TODO: Aquí faltaria estrategia, devorarse a uno mismo no suele ser buena idea
      [
